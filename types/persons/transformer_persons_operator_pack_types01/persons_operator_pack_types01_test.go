...
import (
	...
	types012 "github.com/pavlo67/data_exchange/types01"
	...
	"github.com/pavlo67/data_exchange/types/persons/persons_sqlite"
)
...
func TestTransformPersonsOperatorPack(t *testing.T) {
	...
	dataInitial := structures.PackAny{
		...
		PackData: structures.NewDataAny([]types012.Person{
			{
				Nickname: "wqerwqer",
				Roles:    nil,
